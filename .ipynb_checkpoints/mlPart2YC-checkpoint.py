  ...
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "{'model_name': 'LogisticRegression', 'test_score': 0.8392857142857143, 'best_score': 0.7667597765363129, 'best_model': LogisticRegression(C=100.0)}\n",
      "(2148, 100)\n",
      "(560, 100)\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\ProgramData\\Anaconda3\\envs\\ML\\lib\\site-packages\\sklearn\\model_selection\\_search.py:921: UserWarning: One or more of the test scores are non-finite: [0.91014898 0.89478585 0.89571695        nan]\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "{'model_name': 'LGBMClassifier', 'test_score': 0.8160714285714286, 'best_score': 0.9101489757914338, 'best_model': LGBMClassifier(metric='binary_logloss')}\n",
      "(2148, 100)\n",
      "(560, 100)\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\ProgramData\\Anaconda3\\envs\\ML\\lib\\site-packages\\sklearn\\model_selection\\_search.py:289: UserWarning: The total space of parameters 2 is smaller than n_iter=200. Running 2 iterations. For exhaustive searches, use GridSearchCV.\n",
      "  % (grid_size, self.n_iter, grid_size), UserWarning)\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "{'model_name': 'RandomForestClassifier', 'test_score': 0.8017857142857143, 'best_score': 0.9143389199255121, 'best_model': RandomForestClassifier(bootstrap=False)}\n",
      "(2148, 100)\n",
      "(560, 100)\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\ProgramData\\Anaconda3\\envs\\ML\\lib\\site-packages\\sklearn\\model_selection\\_search.py:289: UserWarning: The total space of parameters 1 is smaller than n_iter=200. Running 1 iterations. For exhaustive searches, use GridSearchCV.\n",
      "  % (grid_size, self.n_iter, grid_size), UserWarning)\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "[19:48:36] WARNING: C:/Users/Administrator/workspace/xgboost-win64_release_1.3.0/src/learner.cc:1061: Starting in XGBoost 1.3.0, the default evaluation metric used with the objective 'binary:logistic' was changed from 'error' to 'logloss'. Explicitly set eval_metric if you'd like to restore the old behavior.\n",
      "{'model_name': 'XGBClassifier', 'test_score': 0.8017857142857143, 'best_score': 0.840316573556797, 'best_model': XGBClassifier(base_score=0.5, booster='gbtree', colsample_bylevel=1,\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "{'model_name': 'SVC', 'test_score': 0.8428571428571429, 'best_score': 0.7527932960893855, 'best_model': SVC(C=1)}\n"
     ]
    }
   ],
   "source": [
